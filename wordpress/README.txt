...
A lightweight plugin that automatically opens any PDF file with SimplePDF.eu: allowing your visitors to fill and edit PDFs (merge, rotate, delete pages) without leaving your website.
...
== Features ==
- Any .pdf link on your website is automatically opened with SimplePDF.eu
...
3. Optional: Go to Settings > SimplePDF Embed and enter your "Company Identifier" (requires a SimplePDF.eu account)
...
All the existing PDF files will now open with SimplePDF.eu.
