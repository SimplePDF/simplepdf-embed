...
const VARIANT_CLASS: Record<ButtonVariant, string> = {
  primary: 'bg-sky-600 text-white hover:bg-sky-700 disabled:cursor-not-allowed disabled:bg-slate-300',
  secondary:
  ...
  ghost: 'text-slate-500 hover:text-sky-700 disabled:cursor-not-allowed disabled:text-slate-300',
}
