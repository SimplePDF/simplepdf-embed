...
export type CreateFieldOutput = { field_id: string }
export type DeleteFieldsInput = { field_ids?: string[]; page?: number }
export type DeleteFieldsOutput = { deleted_count: number }
...
export type DetectFieldsOutput = { detected_count: number }
export type DownloadInput = Record<string, never>
export type DownloadOutput = null
export type FocusFieldInput = { field_id: string }
export type FocusFieldOutput = { hint: { type: "user_action_expected"; message: string } }
export type GetDocumentContentInput = { extraction_mode?: ExtractionMode }
...
export type GetFieldsOutput = { fields: Array<{ field_id: string; name: string | null; type: FieldType; page: number; value: string | null; options: string[] | null }> }
export type GoToInput = { page: number }
export type GoToOutput = null
export type LoadDocumentInput = { data_url: string; name?: string; page?: number }
export type LoadDocumentOutput = null
export type MovePageInput = { from_page: number; to_page: number }
...
export type SetFieldValueInput = { field_id: string; value: string | null }
export type SetFieldValueOutput = null
export type SubmitInput = { download_copy: boolean }
