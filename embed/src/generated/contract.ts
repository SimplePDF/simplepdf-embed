...
export const OPERATIONS = [
  {
    ...
    input_schema: {"type":"object","properties":{"type":{"type":"string","enum":["TEXT","SIGNATURE","PICTURE","CHECKBOX","COMB_TEXT"],"description":"Field type to create."},"x":{"type":"number","description":"Field x position, in PDF points."},"y":{"type":"number","description":"Field y position, in PDF points."},"width":{"type":"number","description":"Field width, in PDF points."},"height":{"type":"number","description":"Field height, in PDF points."},"page":{"type":"integer","description":"1-based page to place the field on."},"value":{"description":"Optional initial value. A string for text/checkbox fields, or a data URL for signature/picture fields.","type":"string"}},"required":["type","x","y","width","height","page"]},
  ...
  } /* CreateField */,
  {
    ...
    input_schema: {"type":"object","properties":{"fieldIds":{"description":"IDs of the fields to delete. Omit to delete every field on the target page.","type":"array","items":{"type":"string"}},"page":{"description":"1-based page to scope the deletion to. Omit to target all pages.","type":"integer"}}},
  ...
  } /* DeleteFields */,
  {
    ...
    input_schema: {"type":"object","properties":{"pages":{"type":"array","items":{"type":"integer"},"description":"1-based page numbers to delete."}},"required":["pages"]},
  ...
  } /* Download */,
  {
    ...
    input_schema: {"type":"object","properties":{"fieldId":{"type":"string","description":"ID of the field to focus and scroll into view."}},"required":["fieldId"]},
  ...
  } /* FocusField */,
  {
    ...
    input_schema: {"type":"object","properties":{"extractionMode":{"description":"Extraction strategy: 'auto' (default) or 'ocr' to force optical recognition.","type":"string","enum":["auto","ocr"]}}},
  ...
  } /* GetFields */,
  {
    ...
    input_schema: {"type":"object","properties":{"page":{"type":"integer","description":"1-based page to navigate to."}},"required":["page"]},
  ...
  } /* GoTo */,
  {
    ...
    input_schema: {"type":"object","properties":{"dataUrl":{"type":"string","description":"The document to load, as a data URL."},"name":{"description":"Optional display name for the document.","type":"string"},"page":{"description":"Optional 1-based page to open the document on.","type":"integer"}},"required":["dataUrl"]},
  ...
  } /* LoadDocument */,
  {
    ...
    input_schema: {"type":"object","properties":{"fromPage":{"type":"integer","description":"1-based current position of the page to move."},"toPage":{"type":"integer","description":"1-based destination position for the page."}},"required":["fromPage","toPage"]},
    error_codes: ["forbidden:editing_not_allowed", "bad_request:invalid_page", "bad_request:page_out_of_range", "bad_request:no_document_loaded", "bad_request:page_not_found"] as const,
    is_agentic_tool: true,
    has_output: false,
  } /* MovePage */,
  {
    ...
    input_schema: {"type":"object","properties":{"page":{"type":"integer","description":"1-based page to rotate 90 degrees clockwise."}},"required":["page"]},
    error_codes: ["forbidden:editing_not_allowed", "bad_request:invalid_page", "bad_request:page_out_of_range", "bad_request:no_document_loaded", "bad_request:page_not_found"] as const,
    is_agentic_tool: true,
    has_output: false,
  } /* RotatePage */,
  {
    ...
    input_schema: {"type":"object","properties":{"tool":{"anyOf":[{"type":"string","enum":["TEXT","SIGNATURE","PICTURE","CHECKBOX","COMB_TEXT"]},{"type":"null"}],"description":"Tool to activate, or null to deselect."}},"required":["tool"]},
  ...
  } /* SelectTool */,
  {
    ...
    input_schema: {"type":"object","properties":{"fieldId":{"type":"string","description":"ID of the field to update."},"value":{"anyOf":[{"type":"string"},{"type":"null"}],"description":"New value for the field, or null to clear it. If the field has options (see get_fields), it must be one of them; otherwise a string (text/checkbox) or a data URL (signature/picture)."}},"required":["fieldId","value"]},
  ...
  } /* SetFieldValue */,
  {
    ...
    input_schema: {"type":"object","properties":{"downloadCopy":{"type":"boolean","description":"When true, the signer also receives a downloaded copy on submit."}},"required":["downloadCopy"]},
