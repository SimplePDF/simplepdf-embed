...
// the hand-maintained EditorEvent union must exactly match the generated outbound events
...
export type DriftGuards = [
  ...
  AssertTrue<Exact<Schemas.GetAnnotatedPageInput, Contract.GetAnnotatedPageInput>>,
