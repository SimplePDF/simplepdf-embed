...
export const TOOL_INPUT_SCHEMAS = {
  ...
  getAnnotatedPage: {"type":"object","properties":{"page":{"type":"integer","description":"1-based page to render, at its current position."}},"required":["page"]},
  ...
  setFieldValue: {"type":"object","properties":{"fieldId":{"type":"string","description":"ID of the field to update."},"value":{"anyOf":[{"type":"string"},{"type":"null"}],"description":"New value for the field, or null to clear it. If the field has options (see the field list), it must be one of them; otherwise a string (text/checkbox) or a data URL or http(s) URL, fetched by the editor (signature/picture)."}},"required":["fieldId","value"]},
